...
import 'package:bookly/feautures/onboarding_screen/presentation/views/onBoarding_ascreen_view.dart';
...
abstract class AppRouter {
  ...
  static const String onBoardingScreen = "/OnBoarderingScreen";
  static GoRouter router = GoRouter(
    routes: [
      ...
      GoRoute(
        ...
        , //هي دي البداية
        builder: (context, state) => const OnboardingAscreenView(),
      ),
      GoRoute(
